...
- [Основные термины](#основные-термины)
  ...
  * [Практика: Рас смотр свойства видео](#практика-рассмотр-свойства-видео)
- [Удаление избыточности](#удаление-избыточности)
  * [Цвета, яркость и глаза](#цвета-яркость-и-глаза")
    ...
    + [Цветовая дискретизация](#цветовая-субдискретизация)
  ...
  * [Типы кадров](#типы-кадров)
    ...
    + [Конспект](#конспект)
  * [Временная избыточность (меж предсказание)](#временная-избыточность-меж-предскозание)
...
- [Как работает видеокодек?](#как-работает-видеокодек)
  ...
  * [6-й шаг - формат битового потока](#6-й-шаг---формат-битового-потока)
    ...
    + [Практика: Проверка битового потока H.264](#практика-проверйа-битовога-потока-h264)
  * [Обзор](#oбзор)
