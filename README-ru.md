...
- [Интро](#intro)
- [Индекс](#index)
- [Основные термины](#basic-terminology)
  * [Другие способы кодирования цветного изображения](#other-ways-to-encode-a-color-image)
  * [Практика: експерементируем цветами и изображениями](#hands-on-play-around-with-image-and-color)
  * [DVD это DAR 4:3](#dvd-is-dar-43)
  * [Практика: Проверка свойства видео](#hands-on-check-video-properties)
- [Удаление избыточности](#redundancy-removal)
  * [Цвета, яркость и глаза](#colors-luminance-and-our-eyes)
    + [Модель цвета](#color-model)
    + [Преобразование между YCbCr и RGB](#converting-between-ycbcr-and-rgb)
    + [Хрома сабсамплинг](#chroma-subsampling)
    + [Практика: Проверка гистограммы YCbCr](#hands-on-check-ycbcr-histogram)
  * [Типы кадров](#frame-types)
    + [И кадр (интра, ключевой кадр)](#i-frame-intra-keyframe)
    + [П кадр (предсказанный)](#p-frame-predicted)
      - [Практика: Видео с единым I-кадром](#hands-on-a-video-with-a-single-i-frame)
    + [Б кадр (двунаправленного предсказания)](#b-frame-bi-predictive)
      - [Практика: Сравнивание видео с Б-кадрами](#hands-on-compare-videos-with-b-frame)
    + [Аннотация](#summary)
  * [Временная избыточность (меж предскозание)](#temporal-redundancy-inter-prediction)
      - [Практика: Обзор векторов движения](#hands-on-see-the-motion-vectors)
  * [Пространственная избыточность (внутреннее предсказание)](#spatial-redundancy-intra-prediction)
      - [Практика: проверка внутренних предсказаний](#hands-on-check-intra-predictions)
- [Как работает видеокодек?](#how-does-a-video-codec-work)
  * [Что? Почему? Как?](#what-why-how)
  * [История](#history)
    + [Рождение AV1](#the-birth-of-av1)
  * [Универсальный кодек](#a-generic-codec)
  * [1-й шаг - разделение изображений](#1st-step---picture-partitioning)
    + [Практика: Проверка разделов](#hands-on-check-partitions)
  * [2-й шаг - предсказания](#2nd-step---predictions)
  * [3-й шаг - преобразования](#3rd-step---transform)
    + [Практика: выбрасывание разных коэффициентов](#hands-on-throwing-away-different-coefficients)
  * [4-й шаг - квантование](#4th-step---quantization)
    + [Практика: квантование](#hands-on-quantization)
  * [5-й шаг - энтропийное кодирование](#5th-step---entropy-coding)
    + [VLC-кодирование](#vlc-coding)
    + [Арифметическое кодирование](#arithmetic-coding)
    + [Практика: CABAC vs CAVLC](#hands-on-cabac-vs-cavlc)
  * [6-й шаг - формат битового потока](#6th-step---bitstream-format)
    + [H.264 битовый поток](#h264-bitstream)
    + [Практика: Проверйа битовога потока H.264](#hands-on-inspect-the-h264-bitstream)
  * [Обзор](#review)
  * [Как H.265 обеспечивает лучшую степень сжатия чем H.264??](#how-does-h265-achieve-a-better-compression-ratio-than-h264)
- [Онлайн трансляция](#online-streaming)
  * [Общая архитектура](#general-architecture)
  * [Прогрессивная загрузка и адаптивная передача](#progressive-download-and-adaptive-streaming)
  * [Защита контента](#content-protection)
- [Как использовать jupyter](#how-to-use-jupyter)
